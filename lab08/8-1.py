...
try: 
    ...
    rects, weights = hog.detectMultiScale(img, winStride = (3, 3) ,  scale = 1.1, useMeanshiftGrouping= False)
    ...
    faces = face_cascade.detectMultiScale( img , scaleFactor = 1.1 , minNeighbors = 5 , minSize = (30,30), maxSize = (50,50)) 
    ...
    cv2.putText(img, str(tvec_f[2]) , (10,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 1, cv2.LINE_AA )
